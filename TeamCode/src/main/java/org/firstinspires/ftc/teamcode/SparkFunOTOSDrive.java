...
public class SparkFunOTOSDrive extends MecanumDrive {
    public static class Params {
        ...
        // RR localizer note: These units are inches and radians. TODO: Remember 2.808
        public SparkFunOTOS.Pose2D offset = new SparkFunOTOS.Pose2D(4.156, -0.655, Math.toRadians(89.22+270));
        ...
        public double linearScalar = 0.971686;
        public double angularScalar = 0.9975;
    }
    ...
    public SparkFunOTOSDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        otos = hardwareMap.get(SparkFunOTOSCorrected.class,"odometry");
        // RR localizer note:
